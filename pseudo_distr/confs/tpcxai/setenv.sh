...
export TPCx_AI_HOME_DIR=/home/$USER/deploy/tpcx-ai-v1.0.2
...
export YARN_CONF_DIR=/home/$USER/deploy/hadoop-3.3.2/etc/hadoop

# Location of the Python binary of the virtual environment used to run the DL use cases
 export PYSPARK_PYTHON=${TPCx_AI_HOME_DIR}/lib/python-venv/bin/python
 export PYSPARK_DRIVER_PYTHON=${TPCx_AI_HOME_DIR}/lib/python-venv/bin/python
